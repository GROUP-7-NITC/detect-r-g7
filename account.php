...
<div class="upload" style="padding:0px !important;border-radius: 5px !important;">
		...
		<div class="login-form">
			<form method="post" action="upload1.php" enctype="multipart/form-data">
				<div>
					<span>Title</span>
						<input class="myfont" style="border-radius: 3px;font-size: 18px;" type="text" name="title" class="title" placeholder="Alphabets only" pattern="[a-zA-Z\s]+" required="*required" />
				</div>
				<div>
					<span>Description</span>
						<input style="border-radius: 3px;font-size: 18px;" type="text" name="describe" class="describe" placeholder="Alphabets only" pattern="[a-zA-Z\s]+" required="*required"/>
				</div>
				<div class="select">
				<span style="padding-bottom: 20px;padding-top: 20px;">Select Guide</span>
				<select required style="background: #f5f5f5;height: 40px;width: 240px;font-size: 16px;padding-left: 20px;border-radius: 5px;" name="guide" >
				  <option value="">Select Guide here ...</option>
					 ...
					 {  ?>
						 ...
						 <option value="<?php echo $r['guide_name']; ?>"> <?php echo $r['guide_name']; ?></option>
						 <?php
					 }
					 ?>
                </select>
