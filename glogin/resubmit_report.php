...
<center>        
<h56><h1 style="padding: 10px 30px 0px 30px;" class="myfont"><i class="fa fa-upload fa-lg"></i> &nbsp;PLEASE RE-UPLOAD YOUR FILE</h1>
...
<div class="upload" style="padding:0px !important;border-radius: 5px !important;">
        ...
        <div class="login-form">
            <form method="post" action="resubmit.php" enctype="multipart/form-data">
               <div>
                    <span>Tracking ID</span>
                        <input style="border-radius: 3px;font-size: 18px;" type="text" name="id" class="describe" required="*required" placeholder="Eg: Enter unique Tracking ID." />
                </div>
                <div>
                    <span>Title</span>
                        <input class="myfont" style="border-radius: 3px;font-size: 18px;" type="text" name="title" class="title" required="*required" placeholder="Eg: Title of file"  />
                </div>
                <div>
                    <span>Description</span>
                        <input style="border-radius: 3px;font-size: 18px;" type="text" name="describe" class="describe" required="*required" placeholder="Eg: Description of the file" />
                </div>
